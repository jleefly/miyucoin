...
// coinvest, 구분자
const string strMessageMagic = "MiyuCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight+1 < 47000)
    {
        nSubsidy = 143 * COIN;
    }
    else if(pindexBest->nHeight+1 < 64000)
    {
        nSubsidy = 10 * COIN;
    }
    else if(pindexBest->nHeight+1 < 52560000)
    {
        nSubsidy = 1 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MiyuCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Wednesday, 21-Dec-16 16:14:53 UTC";
        CTransaction txNew;
        // coinvest, 최초 시작 시간
        txNew.nTime = 1482336893;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        // coinvest, MerkleRoot
        assert(block.hashMerkleRoot == uint256("0x742fb6cfade9eb4c6ef676816117b447a7d9c411e44b9ffb93e96ece85f69302"));
        block.print();
