...
win32 {
    ...
    MINIUPNPC_INCLUDE_PATH=c:/deps/miniupnpc1.9
    MINIUPNPC_LIB_PATH=c:/deps/miniupnpc1.9/miniupnpc
    RELEASE=1
    CONFIG += static
    DESTDIR = release
}
...
macx {
    QMAKE_TARGET_BUNDLE_PREFIX = miyucoin
    DEFINES += IS_ARCH_64
...
macx:ICON = src/qt/res/icons/MiyuCoin.icns
macx:TARGET = "MiyuCoin-Qt"
